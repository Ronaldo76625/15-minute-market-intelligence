/*
 * PANEL ESTADISTICO DESACTIVADO
 *
 * Este archivo conserva la interfaz completa de estadísticas para una posible
 * restauración futura. No está importado por la aplicación pública, por lo
 * que sus componentes, gráficas y consultas no se ejecutan en producción.
 */
